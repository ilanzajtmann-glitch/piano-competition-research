...
checks=['candidate_count_check.py','result_consistency_check.py','source_url_check.py','duplicate_work_check.py','repertoire_completeness_check.py','missing_data_report.py']
